...
Vagrant.configure("2") do |config|
    ...
    routers = {
        "router-1" => { "int_ip" => "192.168.100.1/24", "ext_ip" => "192.168.101.1/24", "vagrant_ip" => "192.168.110.1/24" },
        "router-2" => { "int_ip" => "192.168.100.2/24", "ext_ip" => "192.168.102.1/24", "vagrant_ip" => "192.168.110.2/24" },
        "router-3" => { "int_ip" => "192.168.100.3/24", "ext_ip" => "192.168.103.1/24", "vagrant_ip" => "192.168.110.3/24" }, 
        "router-4" => { "int_ip" => "192.168.100.4/24", "ext_ip" => "192.168.104.1/24", "vagrant_ip" => "192.168.110.4/24" }
    }
